...
const getFA2Settings = (nodeCount) => {
...
const getLayoutDuration = (nodeCount) => {
...
export const useSigma = (options = {}) => {
    ...
    const animatedNodesRef = useRef(new Map());
    const visibleEdgeTypesRef = useRef(null);
            ...
            sigma = new Sigma(graph, containerRef.current, {
                ...
                edgeReducer: (edge, data) => {
                    ...
                    if (visibleTypes && data.relationType) {
                        if (!visibleTypes.includes(data.relationType)) {
                            res.hidden = true;
                            return res;
                        }
                    }
    ...
    const runLayout = useCallback((graph) => {
